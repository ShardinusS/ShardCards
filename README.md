...
- **Abonnements mensuels** : 5€, 10€, 15€ par mois pour débloquer les fonctionnalités de base
- **Publicités intrusives** : Bannières qui interrompent votre apprentissage
...
1. **Une bannière d'installation** peut apparaître automatiquement en bas de l'écran
   - Si c'est le cas, appuyez sur **"Installer"** ou **"Ajouter à l'écran d'accueil"**

2. **Sinon**, appuyez sur le **menu** (3 points) en haut à droite
   - Sélectionnez **"Ajouter à l'écran d'accueil"** ou **"Installer l'application"**

3. **Confirmez l'installation** dans la popup qui apparaît
...
ShardCards utilise l'algorithme SM-2 (SuperMemo 2), un des algorithmes de répétition espacée les plus efficaces :

- **Encore** : La carte est réinitialisée, révision dans 1 jour
...
ShardCards utilise un format JSON simple et lisible :
...
├── service-worker.js   # Service Worker pour cache offline et notifications
├── icon-1024.png      # Icône 1024x1024 (Apple)
├── decks_base/        # Decks de base inclus
│   ├── Chapitre 1 - Suites Numériques.json
│   ├── Chapitre 2 - Limites de fonctions.json
│   ├── Chapitre 3 - Dérivation et Variations.json
...
1. **Révisez régulièrement** : Mieux vaut réviser 10 minutes par jour que 1 heure par semaine
2. **Soyez honnête** : Cliquez sur "Encore" si vous ne connaissez pas la réponse, même si c'est frustrant
3. **Créez des cartes courtes** : Une information par carte est plus efficace
4. **Utilisez les images** : Les images aident à la mémorisation visuelle
5. **Configurez des rappels** : Ne laissez pas trop de temps entre les révisions

### Organisation de vos decks

- **Par matière** : Un deck par matière (Mathématiques, Histoire, etc.)
- **Par chapitre** : Un deck par chapitre pour une matière
- **Par thème** : Organisez par thème si vous préférez
- **Mélangez** : Vous pouvez avoir plusieurs types d'organisation
...
**Faites passer le mot ! Partagez cette application avec vos amis, vos collègues, vos étudiants !**
